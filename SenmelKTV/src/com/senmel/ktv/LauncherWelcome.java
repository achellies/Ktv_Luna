...
public class LauncherWelcome extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		home.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// 打开扫描界面扫描条形码或二维码
				Intent mainKTV = new Intent(LauncherWelcome.this, MainKTV.class);
				startActivity(mainKTV);
			}
		});
		...
		scanBarCodeButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// 打开扫描界面扫描条形码或二维码
				Intent openCameraIntent = new Intent(LauncherWelcome.this,
			...
			public void onClick(View v) {
				try {
					...
					if (!contentString.equals("")) {
						...
						Toast.makeText(LauncherWelcome.this,
